...
try
    ...
    if pilihan_soal == 2
        res_I1 = eval('i1_soalA'); 
        res_I2 = eval('i2_soalA');
        res_I4 = eval('i4_soalA');
        
        % Ambil data sensor tegangan dari Simulink (Soal A)
        res_V1 = eval('v1_soalA'); 
        res_V2 = eval('v2_soalA');
        res_V3 = eval('v3_soalA');
        res_V4 = eval('v4_soalA');
        ...
        set(handles.hasil_v1, 'String', num2str(v1_val, '%.2f'));
        set(handles.hasil_v2, 'String', num2str(v2_val, '%.2f'));
        set(handles.hasil_v3, 'String', num2str(v3_val, '%.2f'));
        set(handles.hasil_v4, 'String', num2str(v4_val, '%.2f'));
    ...
    elseif pilihan_soal == 3
        res_I1_B = eval('i1_soalB'); 
        res_I2_B = eval('i2_soalB');
        res_I4_B = eval('i4_soalB');
        
        % Ambil data sensor tegangan dari Simulink (Soal B)
        res_V1_B = eval('v1_soalB'); 
        res_V2_B = eval('v2_soalB');
        res_V3_B = eval('v3_soalB');
        res_V4_B = eval('v4_soalB');
        ...
        % Data Tegangan
        v1_b_val = res_V1_B(end);
        v2_b_val = res_V2_B(end);
        v3_b_val = res_V3_B(end);
        v4_b_val = res_V4_B(end);
        ...
        % nampilin tegangan ke GUI
        set(handles.hasil_v1, 'String', num2str(v1_b_val, '%.2f'));
        set(handles.hasil_v2, 'String', num2str(v2_b_val, '%.2f'));
        set(handles.hasil_v3, 'String', num2str(v3_b_val, '%.2f'));
        set(handles.hasil_v4, 'String', num2str(v4_b_val, '%.2f'));
